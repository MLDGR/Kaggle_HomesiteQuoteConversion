...
model <- h2o.randomForest(ntrees = 1200, max_depth = 13,balance_classes = T,nfolds = 5,min_rows = 35,
                          binomial_double_trees = T,#min_rows = 120,
...
write.csv(submit, "H2O_RF_Kfold_v1.0.csv" , row.names = F)
