...
#train[is.na(train)]   <- 0
#test[is.na(test)]   <- 0
train[is.na(train[,161]),161]<-median(train[,161],na.rm = T)
train[is.na(train[,125]),125]<-median(train[,125],na.rm = T)

test[is.na(test[,161]),161]<-median(test[,161],na.rm = T)
test[is.na(test[,125]),125]<-median(test[,125],na.rm = T)
...
write_csv(submission, "xgb_V2.4.1_1500_5.csv")
