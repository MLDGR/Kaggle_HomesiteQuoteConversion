...
extc = ExtraTreesClassifier(n_estimators=1580,max_features= 268,criterion= 'entropy',min_samples_split= 3,n_jobs=-1,
                            max_depth= 28, min_samples_leaf= 18)      
#gini
extc.fit(X,y)          
...
sample.to_csv('extc_p_V1.1.csv', index=False)        
